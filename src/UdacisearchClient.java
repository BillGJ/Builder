...
public final class UdacisearchClient implements Serializable {
    ...
    static final class Builder {
        ...
        String name = "";
        long id = 0;
        int quarterlyBudget = 0;
        int numEmployees = 0;
        Instant contractStart = Instant.EPOCH;
        Duration contractLength = Duration.ZERO;
        ZoneId timeZone = ZoneId.of("Etc/UTC");
        String billingAddress = "";
        ...
        public UdacisearchClient build(){
            ...
            return new UdacisearchClient(name,
                    id,
                    quarterlyBudget,
                    numEmployees,
                    contractStart,
